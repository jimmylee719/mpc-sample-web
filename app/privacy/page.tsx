...
const SECTIONS = [
  ...
  },
  {
    ...
    body: [
      ...
      '但你一旦按下播放，就是在跟 Google 的伺服器互動，之後的資料處理適用 Google 自己的隱私權政策，不在本站控制範圍內。不想要就用「在 YouTube 開啟」在別的分頁看。',
    ],
  },
  {
    id: 'hosting',
  ...
  },
  {
    ...
    title: '兒童',
    body: [
      '本站是樂器操作教學，沒有年齡限制。本站沒有蒐集個人資料的機制，也不會針對任何年齡層蒐集資料。',
    ],
  },
  {
    id: 'rights',
    ...
    body: [
      ...
      '就本站而言，我們手上沒有你的個人資料。唯一跟你有關的是存在你瀏覽器裡的學習進度，你隨時可以自己清掉。',
    ],
  },
  {
    id: 'changes',
    title: '政策變更',
    body: [
      '網站功能改變時，這一頁會跟著改，並更新最後修訂日期。加上任何追蹤工具都會同步更新這一頁。',
    ],
  },
];
