...
| 3-8 | Song Mode 串接 | 插入、刪除、播放 |
| 3-9 | 匯出、備份、換音色 | 音訊混音／轉序列／Load Kit |
...
| 不得轉貼論壇貼文內容 | 論壇僅作為「發現問題」來源，答案自行實測重寫 |
| 不得轉錄 YouTube 影片為文字 | 僅使用官方 embed |
