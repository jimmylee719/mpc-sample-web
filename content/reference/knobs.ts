...
export const knobRows: KnobRow[] = [
  ...
  {
    id: 'tune',
    screenName: 'Sample · Tune',
    howTo: '在 SAMPLE 頁按 B2',
    enter: ['b2'],
    k1: 'Semi Tune　粗調音高，以半音為單位（−24 ～ 0 ～ 24）',
    k2: 'Fine Tune　細調音高，以音分為單位（−90 ～ 0 ～ 90）',
    k3: 'Warp　改變長度與速度（Off、50–200%、Seq）',
    screen: { t1: 'TUNE', tabs: ['Trim', 'Tune', 'Filter'], bots: ['Semi', 'Fine', 'Warp'], wave: 31 },
    status: 'verified',
    source: '官方手冊 v1.3.0 (RevA)。Warp 模式在 Time Stretch 與 Pitch 之間切換，用 SHIFT + PAD 15 WARP',
  },
  {
    id: 'filter',
    screenName: 'Sample · Filter',
    howTo: '在 SAMPLE 頁按 B3',
    enter: ['b3'],
    k1: 'Cutoff　濾波的中心頻率（0–127）',
    k2: 'Reso　在中心頻率附近做一個突起（0–127）',
    k3: 'Type　濾波型式（Off、Classic、LPF2、LPF4、HPF2、HPF4…）',
    screen: { t1: 'FILTER', tabs: ['Trim', 'Tune', 'Filter'], bots: ['Cutoff', 'Reso', 'Type'], wave: 31 },
    status: 'verified',
    source: '官方手冊 v1.3.0 (RevA)',
  },
  {
    id: 'flex-beat',
    screenName: 'Flex Beat',
    howTo: '按住 SHIFT 再按 PAD FX',
    enter: ['padfx'],
    enterShift: true,
    k1: 'Mode　One Shot 放完就回到 PAD 1，Loop 會一直重複',
    k2: '手冊沒有列出 K2 的功能',
    k3: 'Mix　乾濕比例（0–100%），100% 時完全聽不到原始聲音',
    screen: { t1: 'FLEX BEAT  ONE SHOT', tabs: ['Flex', '', 'Quantize'], bots: ['Mode', '', 'Mix'] },
    status: 'verified',
    source: '官方手冊 v1.3.0 (RevA)。B3 開關 Quantize；PAD 1 是 EMPTY，效果在 PAD 2–16',
  },
  {
    id: 'step-edit',
    screenName: 'Step Edit',
    howTo: '按住 SHIFT 再按 SEQ',
    enter: ['seq'],
    enterShift: true,
    k1: 'Length　序列長度',
    k2: 'Q　量化值，同時決定 ENCODER 一次走幾格',
    k3: 'Velocity　選到那個音的力度',
    shifted: ['—', 'Time Signature　整個專案的拍號', '—'],
    screen: { t1: 'STEP EDIT  BAR 1', tabs: ['Step', 'Q', 'Vel'], bots: ['Length', 'Q 1/16', 'Vel'] },
    status: 'verified',
    source: '官方手冊 v1.3.0 (RevA)。推桿上下推可以把選到的音前後推移，這就是人味的來源；B3 刪除該事件',
  },
  {
    id: 'song',
    screenName: 'Song',
    howTo: '按住 SHIFT 再按 PAD 12',
    enter: ['p12'],
    enterShift: true,
    k1: '這一頁不用 K1–K3。用 B1 匯出',
    k2: 'B2 選擇匯出成音檔或新序列',
    k3: '用 ENCODER 打名字，B3 執行',
    screen: { t1: 'SONG  EXPORT', tabs: ['Export', 'Audio', 'Do It!'], bots: ['', '', ''] },
    status: 'verified',
    source: '官方手冊 v1.3.0 (RevA)：Song 頁的操作走 B 鍵與 ENCODER，手冊未列 K1–K3 功能',
  },
  {
    id: 'project',
    screenName: 'Project',
    howTo: '按住 SHIFT 再按 PAD 16',
    enter: ['p16'],
    enterShift: true,
    k1: '這一頁不用 K1–K3。用 ENCODER 瀏覽選項',
    k2: '按下 ENCODER 選擇',
    k3: '存檔、載入、開新專案、SD Card Access 都在這裡',
    screen: { t1: 'PROJECT', tabs: ['Load', 'Save', 'New'], bots: ['', '', ''] },
    status: 'verified',
    source: '官方手冊 v1.3.0 (RevA)：Project 選單用 ENCODER 操作',
  },
];
