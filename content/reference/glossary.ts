...
export const glossary: GlossaryEntry[] = [
  { en: 'Sample', zh: '樣本', what: '一段被錄進機器裡的聲音，放在一顆 pad 上', lesson: 's1-01' },
  { en: 'Sequence', zh: '序列', what: '一段錄好的演奏，會不斷循環播放', lesson: 's1-01' },
  { en: 'Project', zh: '專案', what: '裝著你所有樣本、序列和設定的一個檔案', lesson: 's1-04' },
  { en: 'Kit', zh: '音色組', what: '一整組配好在 16 顆 pad 上的聲音' },
  { en: 'Bank', zh: '音色庫', what: '16 顆 pad 為一組，總共八組，用 PAD BANK 切換', lesson: 's1-04' },
  { en: 'Pad', zh: '打擊墊', what: '敲的那 16 個方塊，越用力越大聲', lesson: 's1-01' },
  { en: 'Trim', zh: '修剪', what: '把樣本頭尾多餘的部分切掉', lesson: 's1-01' },
  { en: 'Start / End', zh: '起點／終點', what: '樣本從哪裡開始播、播到哪裡停', lesson: 's1-01' },
  { en: 'Loop', zh: '循環', what: '播到底之後從指定的點再接回去' },
  { en: 'Normalize', zh: '正規化', what: '把音量推到最大而不破音', lesson: 's1-01' },
  { en: 'Chop', zh: '切片', what: '把一段長聲音切成好幾塊，分配到 pad 上', lesson: 's1-01' },
  { en: 'Threshold', zh: '門檻', what: '音量超過這個值才開始動作，Chop 的一種切法', lesson: 's1-01' },
  { en: 'Regions', zh: '等分', what: '不管內容，把聲音平均切成 4、8 或 16 塊', lesson: 's1-01' },
  { en: 'Extract', zh: '抽出', what: '把某一塊切片變成獨立樣本，跑到新的 pad', lesson: 's1-01' },
  { en: 'Resample', zh: '重新取樣', what: '把整段循環收成一個新聲音，空出其他 pad', lesson: 's1-01' },
  { en: 'Overdub', zh: '疊錄', what: '循環跑第二輪時繼續往上加東西', lesson: 's1-01' },
  { en: 'Quantize', zh: '量化', what: '把敲歪的音自動貼到節奏格子上', lesson: 's1-01' },
  ...
  { en: 'Knob FX', zh: '旋鈕效果', what: '用旋鈕控制，一次一個，但可以指定單一 pad', lesson: 's1-02' },
