...
export const officialTutorial: OfficialSection = {
  id: 'tutorial',
  title: '官方 Tutorial 的七步',
  intro:
    '手冊第 6 頁的 Tutorial 章節，原文明講「建議照這個順序做」。這是官方唯一一份有明確順序的教學。本站 2026-09-20 起完全跟上。',
  entries: [
    {
      en: 'Playing Sounds',
      zh: '開機、調音量、播放示範專案',
      page: 6,
      lessons: ['s1-01'],
      note: '開機會自動載入示範專案，所以第一件事就是按 PLAY 聽聽看。',
    },
    {
    ...
    },
    {
      ...
      page: 11,
      lessons: ['s1-02', 's2-01'],
      note: '官方排在序列之後，本站 1-2 排在序列之前。理由是取樣是這台機器的靈魂，先做它比較有感。',
    },
...
export const officialChapters: OfficialSection[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { en: 'Recording Sequences', zh: '錄製序列', page: 41, lessons: ['s1-02'] },
  ...
  },
  {
    ...
    entries: [
      ...
      { en: 'Project', zh: '專案存取與 SD Card Access', page: 62, lessons: ['s1-05', 's3-10'] },
    ],
  },
  {
    id: 'appendix',
