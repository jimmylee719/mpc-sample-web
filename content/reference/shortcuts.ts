...
const PAD_WHAT: Record<PadId, string> = {
  ...
  p11: '把目前序列的全部聲音收成一個新樣本，放進你選的 pad',
  p12: '打開 Song 模式，把序列串成一首歌，並匯出成音檔或新序列',
  p13: '把 Start 之前、End 之後的部分實際刪掉',
  p14: '打開 Time Correct 選單，調整各 pad 的時間與量化設定',
  p15: '切換 Warp 模式：Time Stretch 只改長度，Pitch 連音高一起改',
